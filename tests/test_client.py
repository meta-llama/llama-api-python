...
class TestLlamaAPIClient:
    ...
    def test_hardcoded_query_params_in_url(self, client: LlamaAPIClient) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_binary_content_upload(self, respx_mock: MockRouter, client: LlamaAPIClient) -> None:
...
class TestAsyncLlamaAPIClient:
    ...
    async def test_hardcoded_query_params_in_url(self, async_client: AsyncLlamaAPIClient) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_binary_content_upload(self, respx_mock: MockRouter, async_client: AsyncLlamaAPIClient) -> None:
        respx_mock.post("/upload").mock(side_effect=mirror_request_content)
