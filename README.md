...
The REST API documentation can be found on [https://llama.developer.meta.com/](https://llama.developer.meta.com/). The full API of this library can be found in [api.md](api.md).
...
These methods return an [`APIResponse`](https://github.com/meta-llama/llama-api-python/tree/main/src/llama_api/_response.py) object.

The async client returns an [`AsyncAPIResponse`](https://github.com/meta-llama/llama-api-python/tree/main/src/llama_api/_response.py) with the same structure, the only difference being `await`able methods for reading the response content.
