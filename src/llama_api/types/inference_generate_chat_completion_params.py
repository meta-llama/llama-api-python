...
class InferenceGenerateChatCompletionParams(TypedDict, total=False):
...
Message: TypeAlias = Union[MessageUserMessage, MessageSystemMessage, MessageToolResponseMessage, CompletionMessageParam]
